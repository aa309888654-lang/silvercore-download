...
<body>
    ...
    <div class="main-container">
        <main class="doc-page">
            <a href="../tools.html" class="back-link">Back</a>
            <div class="doc-hero">
                <h1>TITLE</h1>
...
$toolsDir = "C:\Users\30988\Desktop\AI\docs\tools"
$pages = @{
    "base64.html" = "Base64"
    "cli.html" = "CLI"
    "coderunner.html" = "Code Runner"
    ...
    "memory.html" = "Memory"
    "vscode.html" = "VSCode"
    "websearch.html" = "Web Search"
}

foreach ($p in $pages.GetEnumerator()) {
    $content = $template -replace "TITLE", $p.Value
    $content | Out-File -FilePath "$toolsDir\$($p.Key)" -Encoding UTF8
    Write-Host "Created $($p.Key)"
}
